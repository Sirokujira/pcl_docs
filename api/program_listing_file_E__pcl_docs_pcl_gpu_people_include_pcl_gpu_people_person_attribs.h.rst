...
.. _program_listing_file_E__pcl_docs_pcl_gpu_people_include_pcl_gpu_people_person_attribs.h:

Program Listing for File person_attribs.h
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_E__pcl_docs_pcl_gpu_people_include_pcl_gpu_people_person_attribs.h>` (``E:\pcl_docs\pcl\gpu\people\include\pcl\gpu\people\person_attribs.h``)
