...
.. _file_pcl_ml_include_pcl_ml_multi_channel_2d_comparison_feature_handler.h:
...
Definition (``pcl\ml\include\pcl\ml\multi_channel_2d_comparison_feature_handler.h``)
------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_ml_include_pcl_ml_multi_channel_2d_comparison_feature_handler.h.rst
...
- ``pcl/ml/multi_channel_2d_comparison_feature.h``

- ``pcl/ml/multi_channel_2d_data_set.h``

- ``pcl/ml/multiple_data_2d_example_index.h``

- ``pcl/ml/point_xy_32f.h``

- ``pcl/ml/point_xy_32i.h``
