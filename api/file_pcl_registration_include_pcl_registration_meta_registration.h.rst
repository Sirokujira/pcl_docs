...
.. _file_pcl_registration_include_pcl_registration_meta_registration.h:
...
Definition (``pcl\registration\include\pcl\registration\meta_registration.h``)
------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_registration_include_pcl_registration_meta_registration.h.rst
...
- ``pcl/registration/impl/meta_registration.hpp``
