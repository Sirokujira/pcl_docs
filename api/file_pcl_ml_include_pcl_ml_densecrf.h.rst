...
.. _file_pcl_ml_include_pcl_ml_densecrf.h:
...
Definition (``pcl\ml\include\pcl\ml\densecrf.h``)
-------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_ml_include_pcl_ml_densecrf.h.rst
