...
.. _file_pcl_keypoints_include_pcl_keypoints_sift_keypoint.h:
...
Definition (``pcl\keypoints\include\pcl\keypoints\sift_keypoint.h``)
--------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_keypoints_include_pcl_keypoints_sift_keypoint.h.rst
...
- ``pcl/keypoints/impl/sift_keypoint.hpp``
