...
.. _file_pcl_common_include_pcl_common_intersections.h:
...
Definition (``pcl\common\include\pcl\common\intersections.h``)
--------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_common_include_pcl_common_intersections.h.rst
...
- ``pcl/common/impl/intersections.hpp``
