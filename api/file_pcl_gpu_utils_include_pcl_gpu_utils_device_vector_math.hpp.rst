...
.. _file_pcl_gpu_utils_include_pcl_gpu_utils_device_vector_math.hpp:

File vector_math.hpp
====================

|exhale_lsh| :ref:`Parent directory <dir_pcl_gpu_utils_include_pcl_gpu_utils_device>` (``pcl\gpu\utils\include\pcl\gpu\utils\device``)
...
Definition (``pcl\gpu\utils\include\pcl\gpu\utils\device\vector_math.hpp``)
---------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_gpu_utils_include_pcl_gpu_utils_device_vector_math.hpp.rst
...
- :ref:`file_pcl_gpu_surface_src_cuda_device.h`
