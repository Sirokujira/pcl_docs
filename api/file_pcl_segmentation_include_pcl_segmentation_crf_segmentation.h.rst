...
.. _file_pcl_segmentation_include_pcl_segmentation_crf_segmentation.h:
...
Definition (``pcl\segmentation\include\pcl\segmentation\crf_segmentation.h``)
-----------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_segmentation_include_pcl_segmentation_crf_segmentation.h.rst
...
- ``pcl/filters/voxel_grid_label.h``
