...
.. _file_pcl_common_include_pcl_common_vector_average.h:
...
Definition (``pcl\common\include\pcl\common\vector_average.h``)
---------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_common_include_pcl_common_vector_average.h.rst
...
- ``pcl/common/impl/vector_average.hpp``
