...
.. _file_pcl_people_include_pcl_people_person_classifier.h:
...
Definition (``pcl\people\include\pcl\people\person_classifier.h``)
------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_people_include_pcl_people_person_classifier.h.rst
...
- ``pcl/people/impl/person_classifier.hpp``
