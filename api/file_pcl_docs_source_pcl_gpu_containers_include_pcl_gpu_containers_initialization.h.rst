...
.. _file_pcl_docs_source_pcl_gpu_containers_include_pcl_gpu_containers_initialization.h:
...
Definition (``pcl_docs\source\pcl\gpu\containers\include\pcl\gpu\containers\initialization.h``)
-----------------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_docs_source_pcl_gpu_containers_include_pcl_gpu_containers_initialization.h.rst
...
- :ref:`file_pcl_docs_source_pcl_gpu_kinfu_src_safe_call.hpp`

- :ref:`file_pcl_docs_source_pcl_gpu_utils_include_pcl_gpu_utils_safe_call.hpp`
