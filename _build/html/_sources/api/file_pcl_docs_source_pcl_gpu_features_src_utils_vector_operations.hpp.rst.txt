...
.. _file_pcl_docs_source_pcl_gpu_features_src_utils_vector_operations.hpp:
...
Definition (``pcl_docs\source\pcl\gpu\features\src\utils\vector_operations.hpp``)
---------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_docs_source_pcl_gpu_features_src_utils_vector_operations.hpp.rst
