...
.. _file_pcl_docs_pcl_gpu_kinfu_src_cuda_device.hpp:
...
Definition (``pcl_docs\pcl\gpu\kinfu\src\cuda\device.hpp``)
-----------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_docs_pcl_gpu_kinfu_src_cuda_device.hpp.rst
