...
.. _file_pcl_docs_source_pcl_gpu_kinfu_large_scale_src_cuda_device.hpp:
...
Definition (``pcl_docs\source\pcl\gpu\kinfu_large_scale\src\cuda\device.hpp``)
------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_docs_source_pcl_gpu_kinfu_large_scale_src_cuda_device.hpp.rst
...
- ``internal.h`` (:ref:`file_pcl_docs_source_pcl_gpu_kinfu_src_internal.h`)

- ``pcl/gpu/kinfu_large_scale/tsdf_buffer.h``

- ``pointer_shift.cu``

- ``utils.hpp`` (:ref:`file_pcl_docs_source_pcl_gpu_octree_src_utils_boxutils.hpp`)
