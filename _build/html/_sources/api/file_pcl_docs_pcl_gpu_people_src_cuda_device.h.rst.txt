...
.. _file_pcl_docs_pcl_gpu_people_src_cuda_device.h:
...
Definition (``pcl_docs\pcl\gpu\people\src\cuda\device.h``)
----------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_pcl_docs_pcl_gpu_people_src_cuda_device.h.rst
